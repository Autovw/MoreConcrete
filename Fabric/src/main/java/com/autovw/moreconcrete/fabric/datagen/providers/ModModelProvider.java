...
public class ModModelProvider extends FabricModelProvider
{
    ...
    public void leverBlock(BlockModelGenerators blockModels, Block lever)
    {
        ...
        ResourceLocation leverModel = new ModelTemplate(Optional.of(leverModelLoc), Optional.empty(), base).create(lever, textureMapping, blockModels.modelOutput);
        ResourceLocation leverModelOn = new ModelTemplate(Optional.of(leverModelOnLoc), Optional.of("_on"), base).create(lever, textureMapping, blockModels.modelOutput);
