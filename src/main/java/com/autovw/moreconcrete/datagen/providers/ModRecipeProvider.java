...
public class ModRecipeProvider extends RecipeProvider {
    ...
    private static void concretePressurePlate(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider pressurePlate, IItemProvider ingredient) {
    ...
    private static void concreteFenceGate(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider fenceGate, IItemProvider ingredient) {
        ShapedRecipeBuilder.shaped(fenceGate, 1)
                .define('#', ingredient)
                .define('X', Items.STICK)
                .pattern("X#X")
                .pattern("X#X")
