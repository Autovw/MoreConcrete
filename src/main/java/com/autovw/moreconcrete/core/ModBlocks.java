...
public class ModBlocks {
    ...
    private static RegistryObject<Block> registerWall(String name, Block parentBlock) {
        RegistryObject<Block> block = BLOCKS.register(name, () -> new WallBlock(Block.Properties.from(parentBlock)));
        ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
        return block;
    }
}
